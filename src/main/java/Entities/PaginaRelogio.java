...
public class PaginaRelogio {
    ...
    public PaginaRelogio() {

    }

    // Construtor para inicializar os valores das variáveis acima
    public PaginaRelogio(double tamanho, int numeroDePaginas, double pagina[]) {
        this.tamanho = tamanho;
        this.numeroDePaginas = numeroDePaginas;
        this.pagina = pagina;
    }

    // Método que executa o algortimo PaginaRelogio
    public void executaPaginaRelogio() {
        ...
        while (tamanhoEspera != 0) {
            for (int i = 0; i < paginas.size(); i++) {
                ...
                // Se o estado não for 0, decrementa
                } else {
